...
public class PickupWaterGun_BottomTank : Interactable
{
    public override void Interact()
    {
        Item item = new Item("WaterGun_BottomTank"); //Name of the weapon prefab that will held in the players hand
